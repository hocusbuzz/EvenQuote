  ...
  const emptyState =
    input.quotes.length === 0
      ? `<p style="font-size:14px; color:#374151;">
          ...
          means either they didn't pick up, or they needed to see the job in person before
          pricing. We're refunding your request — watch for a separate confirmation email.
        </p>`
      : '';
